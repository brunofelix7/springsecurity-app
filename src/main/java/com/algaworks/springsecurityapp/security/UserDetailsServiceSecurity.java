...
/**
 * Forma customizada de buscar um usuário
 */
@Component
public class UserDetailsServiceSecurity implements UserDetailsService{

	private static final Logger logger = Logger.getLogger(UserDetailsServiceSecurity.class.getSimpleName());

	@Autowired
	private DataSource dataSource;

	/**
	 * Carrega um usuário de qualquer lugar (no nosso caso, do banco de dados)
	 */
	@Override
	public UserDetails loadUserByUsername(String login) throws UsernameNotFoundException {
		...
		try {
			...
			UserDetailsSecurity userDetails = buscarUsuario(connection, login);
	...
	public UserDetailsSecurity buscarUsuario(Connection connection, String login) throws SQLException {
		...
		rs.close();
		ps.close();
		return new UserDetailsSecurity(nome, login, password, ativo);
	}
